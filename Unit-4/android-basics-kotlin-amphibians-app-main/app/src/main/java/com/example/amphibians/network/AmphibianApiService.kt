...
object AmphibianApi{
    val retrofitService : AmphibianApiService by lazy{   //allocates memory to object only when it is accessed
        retrofit.create(AmphibianApiService::class.java) // makes the HTTPS call
    }
}
